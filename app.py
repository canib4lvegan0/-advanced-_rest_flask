...
""" Decorated functions to JWT loaders """
...
# TODO: use the is_admin attribute from database instead of environment variable
@jwt.additional_claims_loader
def add_claims_to_jwt(identify):
    return {"is_admin": UserAdmin.get_is_admin(identify)}
...
def revoked_token_callback(jwt_header, jwt_data):
    return {"message": "The token has been revoked", "error": "revoked_token"}, 401
